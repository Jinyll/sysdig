...
public:
	...
	virtual sinsp_container_engine* on_resolve_container(const sinsp_container_manager* manager, sinsp_threadinfo* tinfo, sinsp_container_info& container_info, bool query_os_for_missing_info) = 0;
